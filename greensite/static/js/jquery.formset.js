...
;(function($) {
    $.fn.formset = function(opts)
    {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            */
            ...
            insertDeleteLink = function(row) {
                ...
                var delButtonHTML = '<a role="button" class="' + options.deleteCssClass + '">' + options.deleteText +'</a>';
        ...
        if ($$.length) {
            ...
            var addButtonHTML = '<a role="button" class="' + options.addCssClass + '">' + options.addText + '</a>';
